        ...
        setContent {
            MaterialTheme(typography = Typography(
                ...
                Box(
                    ...
                    Image(painter = painterResource(id = R.drawable.weather_background), contentDescription = null,
                    contentScale = ContentScale.FillHeight, modifier = Modifier.fillMaxSize(), alpha = if (viewModel.state.isLoading) 0.6f else DefaultAlpha)
                    Column(
                        modifier = Modifier
                            .fillMaxSize()
                    ) {
                        TextField(value = searchText, onValueChange = viewModel::onSearchTextChange,
                            modifier = Modifier.fillMaxWidth().padding(16.dp), textStyle = TextStyle(
